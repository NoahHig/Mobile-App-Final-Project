...
@export var bossX = randi_range(0, width-21)
@export var bossY = randi_range(0, height - 13)
...
func generate_map():
	boss_chamber(bossX, bossY)
	for x in range(width):
		set_cell(0, Vector2i(x, -1), 0, Vector2i(7, 2), 0)
		set_cell(0, Vector2i(x, height), 0, Vector2i(7, 2), 0)
	for y in range(height):
		set_cell(0, Vector2i(-1, y), 0, Vector2i(7, 2), 0)
		set_cell(0, Vector2i(width, y), 0, Vector2i(7, 2), 0)
	for x in range(width):
		for y in range(height):
...
func boss_chamber(x, y):
	...
	set_cell(0, Vector2i(x + 10, y + 12), 0, Vector2i(6, 2), 0)
	set_cell(0, Vector2i(x + 10, y + 11), 0, Vector2i(6, 2), 0)
	set_cell(0, Vector2i(x, y + 6), 0, Vector2i(6, 2), 0)
	set_cell(0, Vector2i(x + 1, y + 6), 0, Vector2i(6, 2), 0)
	set_cell(0, Vector2i(x + 20, y + 6), 0, Vector2i(6, 2), 0)
	set_cell(0, Vector2i(x + 19, y + 6), 0, Vector2i(6, 2), 0)
